...
import 'package:parallax_travel_cards_hero/hotel_list.dart';
import 'package:parallax_travel_cards_hero/models/city.dart';
import 'package:parallax_travel_cards_hero/models/demo_data.dart';
import 'package:parallax_travel_cards_hero/styles.dart';
import 'package:parallax_travel_cards_hero/travel_card_list.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              Padding(
                padding:
                    EdgeInsets.symmetric(horizontal: Styles.hzScreenPadding),
                child: Text(
